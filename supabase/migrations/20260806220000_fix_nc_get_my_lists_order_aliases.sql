-- Fix nc_get_my_lists: ORDER BY must use select aliases ("isDefault", "updatedAt"),
-- not underlying column names. Multi-list migration reintroduced this and broke cloud sync.
